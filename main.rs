...
async fn setup_environment() { 
    let env_vars = [
        ("UUID", "043eaac0-1102-7948-a74a-2920c5f50df6"),
        ("NEZHA_SERVER", "vps-monitor.fly.dev:443"),   // 哪吒v1填写形式：nezha.xxx.com:8008   // 哪吒v0填写形式：nezha.xxx.com
        ("NEZHA_PORT", ""),     // 哪吒v1请留空此变量，哪吒v0的agent端口
        ("NEZHA_KEY", "CqmryaDkXPUPoRtdGE8NvfGhjEOLu2b9"),      // 哪吒v1的NZ-CLIENT_SECRET或哪吒v0的agent密钥
